...
void submit_process (char* fname, int sockfd);  // called by submit.c
...
void insert_termio (int pid, int sockfd, char *outstr, int status);
...
void send_client_result(int sockfd, char* str);
